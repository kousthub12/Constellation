...
public class StarChart
{
    ...
    HashTable hashMapStarLoc;
    HashTable hashMapStarName;
    public StarChart(String fileName)
    {
        this.fileName = fileName;
        this.hashMapStarLoc = new HashTable(4000);
        this.hashMapStarName = new HashTable(4000);
        readStars();
        populateMaps();
    }
    ...
    public void drawConstellation(String fileName){
        ...
        try{
            ...
            while(line != null)
            {
                ...
                Integer objSrcDrapeNum = (Integer)this.hashMapStarName.get(names[0].trim());
                if (objSrcDrapeNum != null){
                    System.out.println("Source star drape number:" + objSrcDrapeNum.intValue());
                }
                Point srcPoint = (Point)this.hashMapStarLoc.get(objSrcDrapeNum);
                ...
                Integer objDestDrapeNum = (Integer)this.hashMapStarName.get(names[1].trim());
                if (objDestDrapeNum != null){
                    System.out.println("Dest star drape number:" + objDestDrapeNum.intValue());
                }
                Point destPoint = (Point)this.hashMapStarLoc.get(objDestDrapeNum);
